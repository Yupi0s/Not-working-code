...
@router.chat_join_request(StateFilter(None), F.chat.id == CHANNEL_ID)
async def chat_join_requests(chat_join: ChatJoinRequest, bot: Bot):
    ...
    await bot.send_message(chat_id=chat_join.from_user.id, text='Список доступных комманд:\n\n'
                           '/auth - Авторизация'
                           '/rules - правила клана'
